...
{
    public static class ServiceColletionsExtentions
    {
        ...
        {
            services.AddEndpointsApiExplorer(); //Servico do swagger
            services.AddSwaggerGen(c =>
            {
                ...
                c.AddSecurityDefinition("Bearer", new OpenApiSecurityScheme()
                {
                    ...
                    Description = @"JWT Authorization Exemplo: Bearer edkfdmk12jk2n3n2kl3n2lnklnklnekndklfndlknfl2nklnfkldnnl2knk2fkndkfnkl2"
                });
